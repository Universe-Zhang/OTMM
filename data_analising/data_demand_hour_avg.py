...
plt.plot(np.arange(len(data)) + 1, np.array(data) / 310000, color=color[0], linestyle=':', marker='o', ms=5)
fs = 16
xlabel = 'Hour'
ylabel = 'Demand (10$^3$)'
xtlabel = ["%d:00" % (i) for i in (np.arange(len(ind)))]
# xtlabel = ind
print(xtlabel)
